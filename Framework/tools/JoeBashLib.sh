...
declare   BLACK="${ESC}[0;30m"    #     BLACK
declare  MAROON="${ESC}[0;31m"    #       RED
declare   GREEN="${ESC}[0;32m"    #     GREEN
declare   OLIVE="${ESC}[0;33m"    #     BROWN -> Dunkelgelb
declare    NAVY="${ESC}[0;34m"    #      BLUE
declare  PURPLE="${ESC}[0;35m"    #   MAGENTA
declare    TEAL="${ESC}[0;36m"    #      CYAN
declare  SILVER="${ESC}[0;37m"    #    LTGRAY -> Dunkelweiss
declare    GRAY="${ESC}[0;30;1m"  #      GRAY -> Hellschwarz
declare     RED="${ESC}[0;31;1m"  #     LTRED
declare    LIME="${ESC}[0;32;1m"  #   LTGREEN
declare  YELLOW="${ESC}[0;33;1m"  #    YELLOW
declare    BLUE="${ESC}[0;34;1m"  #    LTBLUE
declare FUCHSIA="${ESC}[0;35;1m"  # LTMAGENTA
declare    AQUA="${ESC}[0;36;1m"  #    LTCYAN
declare   WHITE="${ESC}[0;37;1m"  #     WHITE
